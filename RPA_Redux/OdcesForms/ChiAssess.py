    ...
    for key in chiAssessQ:
        if key == 1:
            ...
            if chiAssessQ[key] == '0-Not at all':
                ...
                SeleniumAbid.driverfind_element_by_id("ContentPlaceHolder1_rdlQ7Code_1").click()
            elif chiAssessQ[key] == '2-Somewhat':
...
def start (y, df): 
    ...
    SeleniumAbid.driver.find_element_by_id("ContentPlaceHolder1_txtEmployeeNumber1").send_keys(str(dataF.iloc[y]["WorkerNum"]))
